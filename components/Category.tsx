  ...
  return (
    ...
    <div className = " flex gap-[15px] ">
        ...
        <div className="">
            ...
            <p className=' text-[15px] font-normal leading-[23px] text-gray-600 ' >Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae laboriosam aliquam voluptas eveniet cum dolor recusandae reiciendis, quae iste iusto.</p>
